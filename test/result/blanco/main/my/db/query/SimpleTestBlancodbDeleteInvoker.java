...
public class SimpleTestBlancodbDeleteInvoker implements BlancoDbQuery {
    ...
    /**
     * SimpleTestBlancodbDeleteInvokerクラスのコンストラクタ。
     *
    ...
    /**
     * SimpleTestBlancodbDeleteInvokerクラスにデータベース接続を設定。
     *
     * @param conn データベース接続
     */
    @Deprecated
    ...
    protected void finalize() throws Throwable {
        super.finalize();
        if (fStatement != null) {
            final String message = "SimpleTestBlancodbDeleteInvoker : close()メソッドによるリソースの開放が行われていません。";
