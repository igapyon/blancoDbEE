...
public class SimpleTestBlancodbUpdateInvoker implements BlancoDbQuery {
    /**
    ...
    /**
     * SimpleTestBlancodbUpdateInvokerクラスのコンストラクタ。
     *
    ...
    /**
     * SimpleTestBlancodbUpdateInvokerクラスにデータベース接続を設定。
     *
     * @param conn データベース接続
     */
    @Deprecated
     ...
     * @param whereColId 'whereColId'列の値
     * @throws SQLException SQL例外が発生した場合。
     */
    public void setInputParameter(final String colText, final String colNumeric, final int whereColId) throws SQLException {
        if (fStatement == null) {
            prepareStatement();
        }
        fStatement.setString(1, colText);
        fStatement.setString(2, colNumeric);
        fStatement.setInt(3, whereColId);
    }
    ...
    protected void finalize() throws Throwable {
        super.finalize();
        if (fStatement != null) {
            final String message = "SimpleTestBlancodbUpdateInvoker : close()メソッドによるリソースの開放が行われていません。";
