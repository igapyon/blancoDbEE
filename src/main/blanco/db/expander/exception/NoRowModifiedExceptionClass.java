 ...
 * @author IGA Tosiki
 */
public class NoRowModifiedExceptionClass {
    /**
     * 例外クラスのクラス名
     */
    ...
    public NoRowModifiedExceptionClass(final BlancoCgObjectFactory cgFactory,
    ...
    public BlancoCgSourceFile expand() {
...

        {
            ...
            listDesc.add("データベースの処理の結果、1行もデータが変更されなかったことを示す例外クラス <br>");
...

        {
            final BlancoCgField cgField = fCgFactory.createField(
                    "SQLSTATE_NOROWMODIFIED", "java.lang.String", null);
...

        {
            ...
            cgMethod.getLineList()
                    .add("super(reason, SQLSTATE_NOROWMODIFIED);");
        }
