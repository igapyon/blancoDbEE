...
/**
 * データベースの処理の結果、1行もデータが検索されなかったことを示す例外クラス
 * 
 ...
 * @author IGA Tosiki
 */
public class NoRowFoundExceptionClass {
    /**
     * 例外クラスのクラス名
     */
    public static final String CLASS_NAME = "NoRowFoundException";

    /**
     * コンストラクタに示すJavaDoc説明。
     */
    private static final String CONSTRUCTOR_JAVADOC = "データベースの処理の結果、1行もデータが検索されなかったことを示す例外クラスのインスタンスを生成します。";
    ...
    public NoRowFoundExceptionClass(final BlancoCgObjectFactory cgFactory,
    ...
    public BlancoCgSourceFile expand() {
...

        {
            ...
            listDesc.add("データベースの処理の結果、1行もデータが検索されなかったことを示す例外クラス <br>");
...

        {
            ...
            cgMethod.getLineList().add("super(reason, SQLSTATE_NOROWFOUND);");
        }
