 ...
 * @author Tosiki Iga
 */
public class PreviousMethod extends BlancoDbAbstractMethod {
    public PreviousMethod(final BlancoDbSetting argDbSetting,
    ...
    public void expand() {
        final BlancoCgMethod cgMethod = fCgFactory.createMethod("previous",
                null);
        ...
        listLine.add("");
        listLine.add("try {");
        listLine.add("return fResultSet.previous();");
