 ...
 * @author Tosiki Iga
 */
public class FirstMethod extends BlancoDbAbstractMethod {
    public FirstMethod(final BlancoDbSetting argDbSetting,
    ...
    public void expand() {
        final BlancoCgMethod cgMethod = fCgFactory.createMethod("first", null);
        ...
        cgMethod.getLangDoc().getDescriptionList().add("カーソルを結果セットの先頭行へ移動します。");
        ...
        listLine.add("");
        listLine.add("try {");
        listLine.add("return fResultSet.first();");
